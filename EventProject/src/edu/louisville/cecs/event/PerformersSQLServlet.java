 ...
 */
@WebServlet("/PerformersSQLServlet")
public class PerformersSQLServlet extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if (connection != null)
        {
            ...
            RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/PerformersProcessor.jsp");
